...
var users = {
	lillebror420: {
		...
		avatar: 'https://cdn.discordapp.com/avatars/341292712869363732/3b08bdc2381317f877f930cafc6115b2.webp?size=128'
	},
	partyfm: {
		username: 'PartyFM',
		nameColor: 'hsl(212, 51%, 59%)',
		bot: true,
		avatar: 'https://www.partyfm.dk/images/mediapack/logo/PFM_Logo_Yellow_Border_BG.png'
	}
};
...
var channelData = [{
	...
	messages: [{
		type: 'input',
		text: 'PFMhjælp',
		user: users.lillebror420
	}, {
		type: 'message',
		delay: 350,
		user: users.partyfm,
		embedData: {
			title: '[emoji id="1f5d2"] Disse commands findes [emoji id="1f5d2"]',
			pill: 'hsl(202, 35%, 68%)',
			thumb: null,
			fields: [{
				name:  'Crew',
				value: '-ban -banliste -bruger -kick -ping '
			}, {
				name: 'Drukspil',
				value: '-kort -mønt -terning -ssp'
			}, {
				name: 'Lyttere',
				value: '-botinfo -invite -np -regler -server -shop -start -stop'
			}, ]
		}
	}]
}, {
	...
	messages: [{
		...
		embedData: {
			...
			pill: 'hsl(202, 35%, 68%)',
			fields: [{
				name: '[emoji id="1f50a"] SPILLER NU [emoji id="1f50a"]',
				value: 'Loca People (What the F**k!) (Bass Power Remix) - PartyFM.dk'
			}, {
				name: '[emoji id="1f50a"] Spiller nu i [emoji id="1f50a"]',
				value: 'Partyfm-Tale'
			},{
				name: '[emoji id="1f50a"] Lyt med [emoji id="1f50a"]',
				value: 'Klik her'
			}, 
		],
			footerIcon: users.partyfm.avatar,
			footer: 'PartyFM.dk '
		}
	}],
